        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    if (!user)
                        throw new errors_models_1.UnauthorizedError("Incorrect email or password", "AuthLogic-Login");
                    // generating token
...
function register(user) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user_model_1.UserModel.create(user)];
                case 1:
                    addedUser = _a.sent();
                    addedUser.password = undefined;
                    token = auth_1.default.generateNewToken(addedUser);
                    return [2 /*return*/, token];
            }
        });
    });
...
function deleteUser(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user_model_1.UserModel.findByIdAndDelete(id)];
                case 1: 
