...
var EncryptionService = /** @class */ (function () {
    ...
    EncryptionService.prototype.setKey = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, promises_1.default.readFile(config_1.default.publicKey, "utf-8")];
                    case 1:
    ...
    EncryptionService.prototype.rsaEncrypt = function (plainText) {
        if (!plainText)
            return null;
        var cipherBuf = crypto_2.default.publicEncrypt({
            key: this.publicKey,
            padding: crypto_2.default.constants.RSA_PKCS1_OAEP_PADDING,
            oaepHash: "sha256",
    ...
    EncryptionService.prototype.sha256 = function (plainText) {
        if (!plainText)
            return null;
        return (0, crypto_1.createHmac)("sha256", config_1.default.salt).update(plainText).digest("hex");
    };
